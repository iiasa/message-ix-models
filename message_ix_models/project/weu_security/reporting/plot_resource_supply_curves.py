...
# Read CSV file
data_path = package_data_path('weu_security', 'resource_supply_curves', 'gas.csv')
...
ax.set_title("Natural Gas Resource Supply Curve by Region", fontsize=15, fontweight="bold")
