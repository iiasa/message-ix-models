...
# Generate edit files
prepare_edit_files(project_name = 'weu_security', 
...
for tec in config['constrained_tec']:
    print(f"...{tec}")
    if os.path.exists(package_data_path("weu_security", "scenario_updates", tec)):
        for file in os.listdir(package_data_path("weu_security", "scenario_updates", tec)):
            base_file = package_data_path("weu_security", "scenario_updates", tec, file)
