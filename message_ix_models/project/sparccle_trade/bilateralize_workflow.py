...
from message_ix_models.tools.bilateralize.adjust_reexports import *
...
# Generate edit files
prepare_edit_files(project_name = 'sparccle_trade', 
...
for model_scen in models_scenarios.keys():
    ...
    print(f"Target model: sparccle_trade/{model_scen}")
    ...
    out_scenario = base_scenario.clone('sparccle_trade', model_scen, keep_solution = False)
