...
def read_magicc_output(sc_string, pp=50):
    ...
    # filter the variable AR6 climate diagnostics|Surface Temperature (GSAT)|MAGICCv7.5.3|50.0th Percentile
    # and region == "World" and year == 2100
    df = df[
        df["Variable"]
        == f"AR6 climate diagnostics|Surface Temperature (GSAT)|MAGICCv7.5.3|{pp}.0th Percentile"
    ]
