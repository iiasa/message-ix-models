...
p.plot_activity(baseyear=False, subset=["clinker_dry_cement", "clinker_wet_cement"])
p.plot_activity(
    baseyear=False, subset=["grinding_ballmill_cement", "grinding_vertmill_cement"]
)
...
p.plot_activity(baseyear=False, subset=["dri_steel", "bf_steel"])
...
from message_data.model.material.data_buildings import (
    BLD_MAT_USE_2020 as bld_demand2020,
)
