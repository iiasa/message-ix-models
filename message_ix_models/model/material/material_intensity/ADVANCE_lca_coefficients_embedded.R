...
read_material_intensities <- function(parameter, data_path, node, year, technology, commodity, level, inv_cost) {

  if (parameter %in% c("input_cap_new", "input_cap_ret", "output_cap_ret")) {
