...
def add_demand(info):
    ...
    urban_dis['value'] = (1e-3 * urban_dis['value']) * (1 - urban_connection_rate_df['value'])

    dmd_df = dmd_df.append(make_df('demand',
                                   node=urban_dis['node'],
                                   commodity='urban_dis',
                                   level='final',
                                   year=urban_dis['year'],
    ...
    rural_dis['value'] = (1e-3 * rural_dis['value']) * (1 - rural_connection_rate_df['value'])
    ...
    urban_collected_wst['value'] = (1e-3 * urban_return_df['value']) * urban_treatment_rate_df['value']
    ...
    rural_collected_wst['value'] = (1e-3 * rural_return_df['value']) * rural_treatment_rate_df['value']
    ...
    urban_uncollected_wst['value'] = (1e-3 * urban_return_df['value']) * (1 - urban_treatment_rate_df['value'])
    ...
    rural_uncollected_wst['value'] = (1e-3 * rural_return_df['value']) * (1 - rural_treatment_rate_df['value'])
