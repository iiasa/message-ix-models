...
# here we need to adapt for a COUNTRY or GLOBAL model
...
# write new file
write.csv(cooltech_cost_shares,paste0(data_subf,'/cooltech_cost_and_shares_ssp_msg.csv'),row.names = FALSE)
