...
for cl in clim_models:
    ...
    for scen in scenarios:
        ...
        if var != "qr":
            ...
            # da.to_netcdf(path_water+f'\{var}_memean_{scen}.nc')
        ...
        # ds = xr.open_dataset(path_water+f'{var}_memean_{scen}.nc')
        # Resample daily data to monthly by summing daily values
        ...
        if monthlyscale:
            ...
            if var == "dis":
                ...
                davg.to_netcdf(
                    path_isimip + f"{var}_90Y_avg_5y__{cl}_{scen}_temp_agg.nc"
                )
                ...
                # read in saved data again to further process
                # da = xr.\
                #    open_dataset( path_isimip+f'\output\{var}_5y__{climmodel}_{scen}_temp_agg.nc')
