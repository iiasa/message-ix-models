...
# list climate models and scenarios, depending on isimip selection
if isimip == "2b":
    climmodels = [
        "gfdl-esm2m",
        "hadgem2-es",
...
def agg_raster(cl, scen):
    if isimip == "2b":
        ...
        wd2 = os.path.join("p:", "ene.model", "NEST", "hydrology", "isimip2b") + os.sep
    else:
        wd1 = os.path.join("p:", "ene.model", "NEST", "hydrology")
        wd = (
            os.path.join(
                "p:",
                "watxene",
        ...
        wd2 = (
            os.path.join(
                "p:", "ene.model", "NEST", "hydrology", "processed_nc4-isimip3b"
            )
            + os.sep
        )
    ...
    if monthlyscale:
        np.arange(2010, 2105, 5)  # NOTE: same for true and false
    else:
        np.arange(2010, 2105, 5)
