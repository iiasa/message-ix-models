...
from message_data.projects.ngfs.util import add_macro_COVID
...
build_techs = [
    "construction_resid_build",  # technology providing residential floorspace activity
    "demolition_resid_build",
    "construction_comm_build",  # technology providing commercial floorspace activity
