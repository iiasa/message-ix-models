...
import pandas as pd
from genno import Key, Keys, MissingKeyError, Quantity
...
def prepare_computer(c: "Computer") -> None:
    ...
    for mode in ("LDV", "vehicle"):
        try:
            ...
            if mode == "LDV" and c.graph["context"].transport.dummy_LDV:
                # Using 'dummy' LDV technologies with no input intensity
                continue
            raise
