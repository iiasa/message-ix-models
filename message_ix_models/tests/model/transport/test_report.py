...
def quiet_genno(caplog):
    """Quiet some log messages from genno generated by :func:`.prepare_reporter`."""
...
def test_simulated_solution(test_context, regions="R12", years="B"):
...
def test_plot_simulated(test_context, plot_name, regions="R12", years="B"):
