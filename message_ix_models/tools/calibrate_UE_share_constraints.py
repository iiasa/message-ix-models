...
from message_ix_models.report.legacy.get_historical_years import main as get_historical_years
from message_ix_models.report.legacy.get_optimization_years import main as get_optimization_years
