...
- :func:`.bare.create_res` accepts a caller-supplied spec and data (:pull:`XXX`).
- Support the 2025 edition of the Climate Policy Database in :mod:`.tools.newclimate` (:pull:`554`).
