...
coal and unconventional hydrocarbons (:numref:`tab-global-ff-res`, :numref:`fig-supply`). However, driven by the tendency toward regional fragmentation, the focus in SSP3 is assumed to be on
