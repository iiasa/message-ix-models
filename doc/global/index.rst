...
These webpages document the IIASA Integrated Assessment Modeling (IAM) framework, also referred to as MESSAGEix-GLOBIOM, owing to the fact that the energy model MESSAGE and the land use model GLOBIOM are its most important components. MESSAGE-GLOBIOM was developed for the quantification of the so-called Shared Socio-economic Pathways (SSPs) which are the first application of the IAM framework.

**This documentation is constantly under development and is being expanded with additional information to reflect the latest changes in the modeling framework.**
