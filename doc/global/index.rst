...
When referring to the software underpinning |MESSAGEix|-GLOBIOM rather than the data or specific assessments, please see the :ref:`“User guidelines and notice” section <message-ix:notice-cite>` of the documentation, which indicates to use at least the following citation:
