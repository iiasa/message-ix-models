...
implementation of MESSAGEix-GLOBIOM, this infrastructure was represented only
...
geological formations [1]_. The updated implementation represents the CO2
...
each region is limited using the prudent-limit estimates from [2]_. In
addition, annual CO2 injection rates are constrained based on estimates from
[3]_. These injection-rate constraints apply to the total amount of CO2
