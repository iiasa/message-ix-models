...
Configuration (:file:`transport/R12/config.yaml`)
=================================================

Note that this is the configuration file for an R12 base model.
...
.. literalinclude:: ../../../../data/transport/R12/config.yaml
   :language: yaml
